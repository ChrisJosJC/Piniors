...
<meta http-equiv="Expires" content="0" />    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"
...
<body>
    ...
    <div class="container" id="cantainer">
                ...
                <?php while ($cat = mysqli_fetch_assoc($categorias)): ?>
                    <div class="categoria">
                        <form action="/quiz/home/<?php echo $cat['tema'] ?>" id="<?php echo $cat['tema'] ?>" method="POST">
                            ...
                            <a href="javascript:{}"
                                onclick="document.getElementById(<?php echo $cat['tema'] ?>).submit(); return false;">
        ...
        <footer>
            <a href="/login">Piniors <i class="fa-brands fa-user"></i> </a>
        </footer>
    </div>
</body>
